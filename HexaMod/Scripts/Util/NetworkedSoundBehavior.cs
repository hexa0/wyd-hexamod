...
namespace HexaMod.Scripts.Util
{
	public class NetworkedSoundBehavior : MonoBehaviour
	{
		[SerializeField]
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE0044:Add readonly modifier", Justification = "required for instantiation to work")]
