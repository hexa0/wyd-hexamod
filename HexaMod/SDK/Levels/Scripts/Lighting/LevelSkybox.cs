...
namespace HexaMod.SDK.Levels.Scripts.Lighting
{
	...
	[ExecuteInEditMode]
	[UnityMigrationIdentifier("HexaMod.7485585a-c70f-412b-967f-9347ee0c7848")]
	public class LevelSkybox : MigratableMonoBehavior
	{
		...
		{
			if (dnmSkybox != null && HexaGlobal.networkManager.curGameMode == GameModes.GetId("daddysNightmare"))
			{
